...
# First date to have data
start_date = "2020-01-02"

### Fill in data up to jan 1, incorporate basic TSA models
# Iterate through counties, create the jan 1 date
# 1. Difference the data (linear growth)
# 2. Interpolate and fill case + death data
# 3. Difference the the interpolated data
# 4. Smooth the interpolated and differenced interpolated data
# 5. 
def post_processing(data_file,
                    ...
                    degree = './data/groomed_data/degree/in_out_degree.csv' 
                   ):
...
#     out_file = './data/groomed_data/county_timeseries_v2.csv'
